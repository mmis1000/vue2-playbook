  ...
  routes: [
    {
      path: '/',
      redirect: '/home',
      component: () => import(/* webpackChunkName: "ajax" */ './layouts/default'),
      children: [
        {
          path: 'home',
          name: 'home',
        ...
        },
        {
          ...
          // this generates a separate chunk (about.[hash].js) for this route
          // which is lazy-loaded when the route is visited.
          component: () => import(/* webpackChunkName: "uml" */ './views/Uml.vue')
        },
        {
          path: 'infinite-table',
          name: 'infinite-table',
          ...
          // this generates a separate chunk (about.[hash].js) for this route
          // which is lazy-loaded when the route is visited.
          component: () => import(/* webpackChunkName: "uml" */ './views/InfiniteTable.vue')
        }
      ]
    }
  ]
